...
class MemeSender(
    ...
    def _load_config_values(self):
        ...
        self.strict_max_emotions_per_message = cfg.get(
        ...
        # 消息处理
        self.remove_invalid_alternative_markup = cfg.get(
        ...
        self.meme_identify_circuit_threshold = cfg.get(
            "meme_identify_circuit_threshold", 5
        )
        self.meme_identify_circuit_cooldown = cfg.get(
            "meme_identify_circuit_cooldown", 300
        )
